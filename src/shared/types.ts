...
export interface UserPreferences{ selectedMeals:Record<Day,Record<MealSlot,boolean>>; cookingWindows:Record<Day,{morning:boolean;evening:boolean}>; appliances:string[]; diet:Diet; budget?:number; dailyCalories?:number; dailyProtein?:number; foodsToAvoid:string[]; preferredCuisines:string[]; maxSessionMinutes:number; }
